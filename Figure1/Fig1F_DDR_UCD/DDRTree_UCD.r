################################################################################
# Fig.1F: DDRTree Dimensionality Reduction — UCD Validation Cohort
#
# Description:
#   Applies DDRTree to voom-normalized RNA-seq data from the UCD validation
...
#
# Input files:
#   - ucd.tpm.voom.csv                  : Voom-normalized TPM expression matrix
#                                          (genes x samples)
#   - ucd.latend.coord.allGenes.csv     : Sample metadata with endotype labels
#                                          and latent coordinates
#
# Output files:
#   - ddrtree.ucd.fhp.csv               : DDRTree 2D coordinates merged with
#                                          sample metadata
